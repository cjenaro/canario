...
/**
 * Primary-instance startup (canario-7ah.13).
 *
 * Everything the app does after winning the single-instance lock, kept
 * in one function instead of a 760-line `else` block so the lock check
 * stays a two-line concern and this body keeps its own reviewable shape.
 * Runs once, at module evaluation, on the primary instance only.
 */
function bootstrapPrimary() {
